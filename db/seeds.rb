...
# User::Admin.create(name: Faker::Name.name, age: 31, contact_no: 1231231231, email: Faker::Internet.unique.email, password: '12345678')
# User::Viewer.create(name: Faker::Name.name, age: 21, factory_id: factory.id, email: Faker::Internet.unique.email, password: '12345678')
